    ...
    <div className="zi-footer-inner">
      <div className="zi-footer-top">
        ...
        <div className="zi-footer-contacts">
          <a href="tel:+385992273740" className="zi-footer-link"><Phone size={15} /> +385 99 22 737 40</a>
          <a href="mailto:zipintellectum@gmail.com" className="zi-footer-link"><Mail size={15} /> zipintellectum@gmail.com</a>
